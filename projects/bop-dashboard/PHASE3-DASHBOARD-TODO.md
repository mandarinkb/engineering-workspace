...
> **สถานะ**: เป็นแค่ design doc เขียนไว้ล่วงหน้า **ยังไม่เริ่ม implement เลย** — เป็นเอกสารคู่กับ [projects/bot-orchestration-platform/PHASE3-ENTERPRISE-FEATURES-TODO.md](../bot-orchestration-platform/PHASE3-ENTERPRISE-FEATURES-TODO.md) (backend design ของ Approval Gate/Resource Pool/Flow Control ฯลฯ) — เอกสารนี้คือฝั่ง**หน้าบ้าน**ที่ทำให้ feature พวกนั้นใช้งานได้จริงผ่าน UI ไม่ใช่แค่ API เฉยๆ
